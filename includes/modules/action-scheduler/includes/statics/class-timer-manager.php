...
if ( ! class_exists( '\Designink\WordPress\Framework\v1_0_3\Action_Scheduler\Timer_Manager', false ) ) {
	...
	final class Timer_Manager {
		 ...
		 * 
		 * @return null|\Designink\WordPress\Framework\v1_0_3\Action_Scheduler\Timer The Timer instance or NULL.
		 */
		 ...
		 * 
		 * @param \Designink\WordPress\Framework\v1_0_3\Action_Scheduler\Timer $Timer The Timer instance to update.
		 ...
		 * 
		 * @param \Designink\WordPress\Framework\v1_0_3\Action_Scheduler\Timer[] The Timers to save.
		 * 
