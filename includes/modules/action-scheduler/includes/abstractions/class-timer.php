...
use Designink\WordPress\Framework\v1_0_4\Action_Scheduler\Action;
use Designink\WordPress\Framework\v1_0_4\Utility;

if ( ! class_exists( '\Designink\WordPress\Framework\v1_0_4\Action_Scheduler\Timer', false ) ) {
	...
	abstract class Timer {
		 ...
		 * Get the Actions.
		 * 
		 * @return \Designink\WordPress\Framework\v1_0_4\Action_Scheduler\Action[] The Actions.
		 */
		 ...
		 * 
		 * @param \Designink\WordPress\Framework\v1_0_4\Action_Scheduler\Action $Action The Action to try and add.
		 ...
		 * 
		 * @return null|\Designink\WordPress\Framework\v1_0_4\Action_Scheduler\Action The Action instance or NULL.
		 */
		...
		/**
		 * A wrapper function for \Designink\WordPress\Framework\v1_0_4\Action_Scheduler\Timer_Manager::update_timer().
		 * 
		 ...
		 * 
		 * @param \Designink\WordPress\Framework\v1_0_4\Action_Scheduler\Timer $Timer The Timer instance to merge Actions from.
		 */
		 ...
		 * 
		 * @return null|\Designink\WordPress\Framework\v1_0_4\Action_Scheduler\Timer The timer that was instantiated or FALSE.
		 */
